...
#  if !SANITIZER_GO
    case 40:
      return MappingImpl<Mapping40, Type>();
#  else
    case 47:
      return MappingImpl<Mapping47, Type>();
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return IsAppMemImpl<Mapping40>(mem);
#  else
    case 47:
      return IsAppMemImpl<Mapping47>(mem);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return IsShadowMemImpl<Mapping40>(mem);
#  else
    case 47:
      return IsShadowMemImpl<Mapping47>(mem);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return IsMetaMemImpl<Mapping40>(mem);
#  else
    case 47:
      return IsMetaMemImpl<Mapping47>(mem);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return MemToShadowImpl<Mapping40>(x);
#  else
    case 47:
      return MemToShadowImpl<Mapping47>(x);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return MemToMetaImpl<Mapping40>(x);
#  else
    case 47:
      return MemToMetaImpl<Mapping47>(x);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return ShadowToMemImpl<Mapping40>(s);
#  else
    case 47:
      return ShadowToMemImpl<Mapping47>(s);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return GetThreadTraceImpl<Mapping40>(tid);
#  else
    case 47:
      return GetThreadTraceImpl<Mapping47>(tid);
#  endif
...
#  if !SANITIZER_GO
    case 40:
      return GetThreadTraceHeaderImpl<Mapping40>(tid);
#  else
    case 47:
      return GetThreadTraceHeaderImpl<Mapping47>(tid);
#  endif
