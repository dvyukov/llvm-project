...
struct EventAccess {
  ...
  u64 is_atomic : 1;
  u64 size_log : 2;
  u64 pc_delta : kPCBits;  // delta from the previous memory access PC
...
struct EventAccessRange {
  ...
  u64 is_access : 1;  // = 0
  u64 is_func : 1;    // = 0
  u64 type : 3;       // = EventTypeAccessRange
  u64 is_read : 1;
  u64 is_free : 1;
...
struct EventLock {
  ...
  u64 is_access : 1;  // = 0
  u64 is_func : 1;    // = 0
  u64 type : 3;       // = EventTypeLock or EventTypeRLock
  u64 pc : kCompressedAddrBits;
