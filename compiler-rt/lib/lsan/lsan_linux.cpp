...
static THREADLOCAL Tid current_thread_tid = kInvalidTid;
Tid GetCurrentThread() { return current_thread_tid; }
void SetCurrentThread(Tid tid) { current_thread_tid = tid; }
